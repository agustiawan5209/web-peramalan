        ...
        <>
           <section className="mb-10 rounded-xl bg-white p-6 shadow-md">
                            ...
                            {predictionEucheuma !== null && (
                                <>
                                    <ul className="mt-6 rounded bg-green-100 p-4 font-semibold text-green-800">
                                        <li>Hasil Prediksi Eucheuma Conttoni: {predictionEucheuma} kg</li>
                                        <li>Hasil Prediksi Gracilia: {predictionGracilaria} kg</li>
                                    </ul>
                                    <ul className="mx-auto bg-primary p-4">
                                        <li className="text-white">Mean Squared Error (MSE): {mse !== null ? mse.toFixed(4) : 'Belum dihitung'}</li>
                                        <li className="text-white">R-Squared: {rSquared !== null ? rSquared.toFixed(4) : 'Belum dihitung'}</li>
                                    </ul>
                                </>
                            )}
